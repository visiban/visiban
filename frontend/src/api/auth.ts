...
export const register = (email: string, password1: string, password2: string, username?: string) =>
  client.post("/api/auth/registration/", { email, password1, password2, ...(username ? { username } : {}) });
