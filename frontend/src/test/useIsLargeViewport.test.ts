...
describe('useIsLargeViewport', () => {
  ...
  it('returns true when the viewport matches the lg breakpoint', () => {
  ...
  it('returns false when the viewport is below the lg breakpoint', () => {
  ...
  it('removes the change listener on unmount', () => {
    ...
    window.matchMedia = matchMedia as unknown as typeof window.matchMedia
    const { unmount } = renderHook(() => useIsLargeViewport())
