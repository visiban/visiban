...
function makeBoard(overrides: Partial<BoardFull> = {}): BoardFull {
  return {
    ...
    cards: [{
      ...
      assignee: null, labels: [], due_date: null, weight: 1, position: 0, created_by: { id: 1, username: "user1", display_name: "User 1", avatar_url: null },
...
describe('useBoard', () => {
  ...
  it('addCard adds a new card', async () => {
    ...
    const newCard: Card = {
      ...
      assignee: null, labels: [], due_date: null, weight: 1, position: 1, created_by: { id: 1, username: "user1", display_name: "User 1", avatar_url: null },
