...
describe('cards API', () => {
  ...
  it('createCard posts to correct URL', async () => {
    ...
    expect(mockClient.post).toHaveBeenCalledWith('/api/v1/boards/5/cards/', { column: 1, swimlane: 2, title: 'New' })
  ...
  it('updateCard patches card', async () => {
    ...
    expect(mockClient.patch).toHaveBeenCalledWith('/api/v1/boards/5/cards/1/', { title: 'Updated' })
    expect(result).toEqual(card)
  })
  ...
  it('deleteCard sends delete request', async () => {
    ...
    expect(mockClient.delete).toHaveBeenCalledWith('/api/v1/boards/5/cards/1/')
  })
  ...
  it('moveCard posts move data', async () => {
    ...
    expect(mockClient.post).toHaveBeenCalledWith('/api/v1/boards/5/cards/1/move/', { column_id: 2, swimlane_id: 3, position: 0 })
  ...
  it('getCardMovements fetches movements', async () => {
    ...
    expect(mockClient.get).toHaveBeenCalledWith('/api/v1/boards/5/cards/1/movements/')
  ...
  it('getCardComments fetches comments', async () => {
    ...
    expect(mockClient.get).toHaveBeenCalledWith('/api/v1/boards/5/cards/1/comments/')
  ...
  it('addCardComment posts comment', async () => {
    ...
    expect(mockClient.post).toHaveBeenCalledWith('/api/v1/boards/5/cards/1/comments/', { body: 'Hello' })
  ...
  describe("deleteComment", () => {
    it("calls DELETE on the comment endpoint", async () => {
      ...
      expect(mockClient.delete).toHaveBeenCalledWith("/api/v1/boards/1/cards/2/comments/99/");
    });
  })
  ...
  it('getCardActivities fetches activities', async () => {
    ...
    expect(mockClient.get).toHaveBeenCalledWith('/api/v1/boards/5/cards/1/activities/')
    expect(result).toEqual([])
  })
  ...
  it('getCardAttachments fetches attachments', async () => {
    ...
    expect(mockClient.get).toHaveBeenCalledWith('/api/v1/boards/5/cards/1/attachments/')
    expect(result).toEqual([])
  })
  ...
  it('uploadCardAttachment posts FormData', async () => {
    ...
    expect(callArgs[0]).toBe('/api/v1/boards/5/cards/1/attachments/')
  ...
  it('deleteCardAttachment sends delete', async () => {
    ...
    expect(mockClient.delete).toHaveBeenCalledWith('/api/v1/boards/5/cards/1/attachments/10/')
  })

  it('getChecklist fetches checklist items', async () => {
    mockClient.get.mockResolvedValue({ data: [] })
    const result = await getChecklist(5, 1)
    expect(mockClient.get).toHaveBeenCalledWith('/api/v1/boards/5/cards/1/checklist/')
    expect(result).toEqual([])
  })
  ...
  it('addChecklistItem posts item', async () => {
    ...
    expect(mockClient.post).toHaveBeenCalledWith('/api/v1/boards/5/cards/1/checklist/', { text: 'Do this' })
  ...
  it('updateChecklistItem patches item', async () => {
    ...
    expect(mockClient.patch).toHaveBeenCalledWith('/api/v1/boards/5/cards/1/checklist/1/', { is_checked: true })
    expect(result).toEqual(item)
  })
  ...
  it('deleteChecklistItem deletes item', async () => {
    ...
    expect(mockClient.delete).toHaveBeenCalledWith('/api/v1/boards/5/cards/1/checklist/1/')
  })
  ...
  describe('archiveCard', () => {
    it('posts to archive endpoint and returns card', async () => {
      ...
      expect(mockClient.post).toHaveBeenCalledWith('/api/v1/boards/5/cards/1/archive/')
      expect(result).toEqual(card)
    })
  })
  ...
  describe('unarchiveCard', () => {
    it('posts to unarchive endpoint and returns card', async () => {
      ...
      expect(mockClient.post).toHaveBeenCalledWith('/api/v1/boards/5/cards/1/unarchive/')
      expect(result).toEqual(card)
    })
  })
  ...
  describe('getArchivedCards', () => {
    it('fetches from archived endpoint and returns paginated page', async () => {
      ...
      expect(mockClient.get).toHaveBeenCalledWith('/api/v1/boards/5/cards/archived/', { params: { offset: 0 } })
    ...
    it('passes offset param when specified', async () => {
      ...
      expect(mockClient.get).toHaveBeenCalledWith('/api/v1/boards/5/cards/archived/', { params: { offset: 50 } })
    })
  })
})
