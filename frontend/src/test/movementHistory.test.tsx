  ...
  members: [
    {
      ...
      user: { id: 10, username: 'admin', email: 'admin@example.com', first_name: 'Admin', last_name: 'User', avatar_url: '', display_name: 'Admin User', is_site_admin: true, must_change_password: false, must_change_username: false },
    },
  ],
...
function makeMv(overrides: Partial<BoardMovement> = {}): BoardMovement {
  return {
    ...
    to_swimlane_uid: 's1',
    moved_by: { id: 10, username: 'admin', email: 'admin@example.com', first_name: 'Admin', last_name: 'User', avatar_url: '', display_name: 'Admin User', is_site_admin: true, must_change_password: false, must_change_username: false },
