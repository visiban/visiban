...
export default function OnboardingEmptyState({ onCreateBoard, onJoinGroup }: Props) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
      <div className="mb-6 text-fg-faint">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <button
          ...
          className="px-6 py-2.5 bg-button-primary hover:bg-button-primary-hover text-on-primary text-sm font-medium rounded transition focus:outline-none focus:ring-2 focus:ring-primary-emphasis"
        >
          Create my first board
        </button>
        <button
          onClick={onJoinGroup}
          className="px-6 py-2.5 border border-line-strong hover:border-line-emphasis text-fg-secondary hover:text-fg text-sm font-medium rounded transition focus:outline-none focus:ring-2 focus:ring-primary-emphasis"
        >
