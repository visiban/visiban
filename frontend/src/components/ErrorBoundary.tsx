        ...
        <div className="min-h-screen bg-sunken flex items-center justify-center p-8">
          <div className="bg-surface rounded-xl p-8 max-w-lg w-full shadow-xl border border-danger/30">
            ...
            <button
              ...
              className="mt-4 bg-primary hover:bg-primary-hover text-fg text-sm px-4 py-2 rounded font-medium transition focus:outline-none focus:ring-2 focus:ring-primary-emphasis"
            >
              Reload
            </button>
          </div>
