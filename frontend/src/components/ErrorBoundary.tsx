        ...
        <div className="min-h-screen bg-sunken flex items-center justify-center p-8">
          <div className="bg-surface rounded-xl p-8 max-w-lg w-full shadow-xl border border-danger/30">
            ...
            <button
              ...
              className="mt-4 bg-blue-600 hover:bg-blue-700 text-white text-sm px-4 py-2 rounded font-medium transition focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              Reload
            </button>
          </div>
