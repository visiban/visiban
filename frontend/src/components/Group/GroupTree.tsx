    ...
    <div className="relative">
      ...
      >
        ...
        <button
          ...
          className="shrink-0 w-5 h-5 flex items-center justify-center rounded text-slate-600 hover:text-blue-400 hover:bg-slate-600 opacity-0 group-hover/row:opacity-100 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
        >
