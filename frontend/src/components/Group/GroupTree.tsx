    ...
    <div className="relative">
      ...
      >
        ...
        <button
          ...
          className="shrink-0 w-5 h-5 flex items-center justify-center rounded text-fg-faint hover:text-info hover:bg-surface-active opacity-0 group-hover/row:opacity-100 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
        >
          ...
          {node.children.map((child, i) => {
            ...
            return (
              <div key={child.group.id} className="relative pl-[16px]">
                ...
                <div
                  className="absolute left-0 w-px bg-surface-active"
                  style={{ top: 0, height: childIsLast ? "50%" : "100%" }}
                />
                {/* Horizontal connector at row midpoint */}
                <div className="absolute left-0 top-[50%] h-px w-[16px] bg-surface-active -translate-y-px" />
