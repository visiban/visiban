...
|------|-------------|-----------|-------|
| `demo_board.json` | General product development board | 10 | ~120 |
| `sales_pipeline.json` | Deal tracking by sales region | 11 | ~120 |
| `customer_support.json` | Support tickets by customer account | 11 | ~120 |
| `customer_success.json` | Account health and lifecycle tracking | 10 | ~120 |
| `simple_kanban.json` | General-purpose team kanban | 10 | ~120 |
| `product_roadmap.json` | Feature tracking from idea to launch | 11 | ~120 |
